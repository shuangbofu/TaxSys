...
<form id="form" name="form" action="${basePath }/user/insert.action" method="post" enctype="multipart/form-data" >
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td>
				<img id="uHeadimg" src="${basePath}/images/home/gs09.png" width="70" height="70" />
                <input type="file" name="uHeadImgFile" id="uHeadImgFile" onchange="javascript:setImagePreview('uHeadImgFile','uHeadimg');"/>
                <input type="hidden" name="uHeadimg" />
            </td>
        </tr>
        <tr>
		...
		<tr>
            ...
            <td><input type="radio" name="uState" value="1" checked="checked"/>未锁定
            	<input type="radio" name="uState" value="2" />已锁定
            </td>
        </tr>
        <tr>
