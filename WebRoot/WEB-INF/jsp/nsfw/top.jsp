...
<body>
			...
			<td width="300" align="right" valign="top">
				<table width="350" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					    <td align="center"></td>
                        <td align="left"></td>
                        <td align="left"><a><b></b><font color="white">欢迎您，${sessionScope.loginUser.uName }</font></a></td>
						...
						<td align="left" valign="middle"><a href="${basePath}user/logout.action" target="_top">退出</a></td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<div class="banner">
		<div class="menu">
			<ul class="clearfix">
				<li><a href="${basePath}home/index.action" target="_top">工作主页</a></li>
