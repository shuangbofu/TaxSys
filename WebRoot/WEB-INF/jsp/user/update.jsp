...
<form id="form" name="form" action="${basePath }user/update.action" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
     <tr>
        ...
        <tr>
            ...
            <td>
            	<c:if test="${empty editedUser.uHeadimg }">
					<img id="uHeadimg${editedUser.uAccount }" src="${basePath}/images/home/gs09.png" width="70" height=70" />
                </c:if>
                <c:if test="${not empty editedUser.uHeadimg }">
                    <img id="uHeadimg${editedUser.uAccount }" src="${basePath }images/headImg/${editedUser.uHeadimg }" width="70" height="70"/>
                </c:if>
              <input type="file" name="uHeadImgFile" id="uHeadImgFile" onchange="javascript:setImagePreview('uHeadImgFile','uHeadimg${editedUser.uAccount }');"/>
              <input type="hidden" name="uHeadimg" value="${editedUser.uHeadimg }"/>
            </td>
        </tr>
        <tr>
		...
		<tr>
            ...
            <td><input type="radio" name="uState" value="true" ${editedUser.uState?'checked':'' }/>未锁定
            	<input type="radio" name="uState" value="false" ${editedUser.uState?'':'checked' }/>已锁定
            </td>
        </tr>
        <tr>
