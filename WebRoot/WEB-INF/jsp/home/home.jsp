        ...
        <td width="331" align="right" valign="top">
            <table width="400" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"></td>
                    <td align="right">
                        <a><b></b><font color="white">欢迎您，${sessionScope.loginUser.uName }&nbsp;&nbsp;&nbsp;</font></a>
                    </td>
                    ...
                    <td align="left" valign="middle" ><a href="${basePath}/user/logout.action">退出</a></td>
                </tr>
            </table>
        </td>
    </tr>
...
<div class="menu">
    <ul class="clearfix">
        ...
        <c:forEach items="${sessionScope.privileges }" var="privilege">
        	<li><a href="${basePath }${fn:replace(privilege.pCode,'#','') }Home/${fn:replace(privilege.pCode,'#','') }Home.action">${privilege.pName }</a></li>
        </c:forEach>
        <!-- 
        <li><a href="javascript:void(0);">行政管理</a></li>
        <li><a href="javascript:void(0);">后勤服务</a></li>
        <li><a href="javascript:void(0);">在线学习</a></li>       
        <li><a href="${basePath }nsfwHome/nsfwHome.action">纳税服务</a> </li>
        <li><a href="javascript:void(0);">我的空间${privileges[0].pName }</a></li>
         -->
            ...
            <table width="98%" border="0" align="center">
                <tr>
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
                            <c:if test="${empty loginUser.uHeadimg }">
								<img src="${basePath}/images/home/gs09.png" width="70" height="70" />
                            </c:if>
                            <c:if test="${not empty loginUser.uHeadimg }">
                            	<img src="${basePath }images/headImg/${loginUser.uHeadimg }" width="70" height="70"/>
                            </c:if>
                        </div>
                    </td>
                    ...
                    <td width="60%"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="2" style=" font-weight:bold; color:#3a7daa;">姓名：${loginUser.uName }</td>
                        </tr>
                        <tr>
                            <td colspan="2" style=" font-weight:bold; color:#3a7daa;">性别：${loginUser.uGender?'男':'女' }</td>
                        </tr>
                        <tr>
                            <td colspan="2" style=" font-weight:bold; color:#3a7daa;">所属部门：${loginUser.uDept.dName }部门</td>
                        </tr>
                        <tr>
                            <td colspan="2" style=" font-weight:bold; color:#3a7daa;">角色：${loginUser.uRole.rName }(${loginUser.uRole.rState?'有效':'已失效' })</td>
                        </tr>
